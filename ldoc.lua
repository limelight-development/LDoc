...
local function setup_kinds ()
   ...
   ProjectMap:add_kind(lookup('weapon','Weapons'))
   ProjectMap:add_kind(lookup('entity','Entities'))
   ProjectMap:add_kind(lookup('tool','Tools'))
   ProjectMap:add_kind(lookup('vehicle','Vehicles'))
